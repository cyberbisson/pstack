// ===-- src/psystem/demangle/cp-demangle.win32.cpp ------- -*- C++ -*- --=== //
// Copyright (c) 2008 Matt Bisson.  All rights reserved.

/**
 * @file
 * @brief Libiberty/GCC C++ name de-mangling functionality.
 *
 * This file is "borrowed" from like 3 different files in libiberty ---
 * cp-demangle.c, demangle.h, cp-demangle.h
 *
 * If you @em really want it, I'll put it back in the open source community,
 * but let's be honest here --- this is a steaming turd that only serves the
 * purpose of compiling for Win32 under MSVC.  I'd rather use the library
 * itself, of course.
 *
...
// Basically, turn off MSVC's warnings, since this file is temporary
#pragma warning (disable: 4127 4244 4267 4510 4512 4610 4701)
...
{
    /**
     * @brief Contains utilities that de-mangle C++ name-mangling from various
     *        compilers.
     */
    namespace demangle
    {
...
d_print_java_identifier (struct d_print_info *dpi, const char *name, int len)
{
    ...
    for (p = name; p < end; ++p)
    {
            ...
            && p[2] == 'U')
        {
            ...
            /* @todo If the Unicode character is larger than 256, we don't try
