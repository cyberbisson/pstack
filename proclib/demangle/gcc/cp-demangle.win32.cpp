/** @file cp-demangle.win32.cpp
 ** @brief This file is stolen from like 3 different files in libiberty:<br>
 **  - cp-demangle.c, demangle.h, cp-demangle.h
 **
 ** If you <i>really</i> want it, I'll put it back in the open source community,
...
#define DEMANGLE_H
   ...
   **        compilers. */
      namespace demangle
      {
          /** @brief Demangles the GCC C++ symbols. */
          namespace gcc
          {
